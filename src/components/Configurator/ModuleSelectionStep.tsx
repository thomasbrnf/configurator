...
import { useConfigurator, availableModules, availableCompleteSets } from "../../context/ConfiguratorContext";
        ...
        <div className="flex-1 overflow-y-auto pt-8">
          <div className="max-w-6xl mx-auto px-8">
            ...
            <div className="flex items-center">
              <button
                onClick={handleBack}
                className="cursor-pointer flex items-center px-4 py-2 text-[#06402b] hover:bg-[#06402b]/10 rounded-lg transition-colors duration-200 mr-6"
              >
              ...
              <div>
                <h1 className="text-lg font-bold text-[#06402b]">
            ...
            {availableCompleteSets.map((set) => (
              ...
              >
                <div className="aspect-video bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                  <svg className="w-16 h-16 text-gray-400 group-hover:text-[#06402b] transition-colors duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M4 16v4h16v-4M4 16L2 8h20l-2 8M4 16h16M8 12V8m8 4V8" />
                  </svg>
                </div>
                <div className="p-4">
        ...
        <div className="max-w-7xl mx-auto px-8 py-8">
          ...
          <div className="flex gap-8">
            ...
            <div className="flex-1">
              <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 pb-20">
            ...
            >
              <div className="aspect-square bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                <svg className={`w-12 h-12 transition-colors duration-300 ${
                  isModuleSelected(module.id) ? 'text-[#06402b]' : 'text-gray-400 group-hover:text-[#06402b]'
          ...
          <div className="flex flex-col items-center space-y-2">
            <div className="flex items-center space-x-3">
              <button
                ...
                className={`px-12 py-2.5 rounded-lg font-semibold text-sm transition-all duration-200 ${
            ...
            <div className="text-xs text-black/35">
              Wybrano: {selectedModules.size} modułów
            </div>
          </div>
        </div>
      </div>
