  ...
  return (
    <div className="fixed inset-0 bg-white/95 backdrop-blur-lg z-[300] flex items-center justify-center">
      <div className="max-w-4xl mx-auto text-center px-8">
        <button
          onClick={handleBack}
          className="cursor-pointer absolute top-8 left-8 flex items-center px-4 py-2 text-[#06402b] hover:bg-[#06402b]/10 rounded-lg transition-colors duration-200"
        >
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl border-2 border-gray-200 hover:border-[#06402b]/40 transition-all duration-300 shadow-lg hover:shadow-xl overflow-hidden group">
            <div className="p-8">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Wybierz gotowy zestaw mebli, który został zaprojektowany przez naszych ekspertów
              </p>
              <button
          ...
          <div className="bg-white rounded-2xl border-2 border-gray-200 hover:border-[#06402b]/40 transition-all duration-300 shadow-lg hover:shadow-xl overflow-hidden group">
            <div className="p-8">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Zbuduj własną konfigurację wybierając poszczególne moduły i komponenty
              </p>
              <button
